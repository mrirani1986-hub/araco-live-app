"""Render tilia2.html (Design II) to PNG.  usage: python3 render2.py [scale] [out.png]"""
import os, sys
...
out = sys.argv[2] if len(sys.argv) > 2 else os.path.join(ROOT, "tilia-announcement-moonlit-arch.png")
...
with sync_playwright() as p:
    ...
    pg.goto("file://" + os.path.join(ROOT, "tilia2.html"))
